...
#ifndef _INCLUDED_JsonLogTransformerFactory_HPP
#define _INCLUDED_JsonLogTransformerFactory_HPP
...
namespace Herald
{
	...
	/// @return
	ILogTransformerBuilderPtr createJsonLogTransformerBuilder();
} // namespace Herald

#endif // _INCLUDED_JsonLogTransformerFactory_HPP